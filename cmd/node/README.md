...
# The Parallelcoin Node [![ISC License](http://img.shields.io/badge/license-ISC-blue.svg)](http://copyfree.org) [![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/l0k18/pod/node)
...
```bash
go get github.com/l0k18/pod/cmd/podctl
```
...
https://github.com/l0k18/pod/releases
...
The [integrated github issue tracker](https://github.com/l0k18/pod/issues)
is used for this project.

## Documentation

The documentation is a work-in-progress. It is located in the [docs](https://github.com/l0k18/pod/tree/master/docs) folder.
