...
https://github.com/l0k18/pod/walletmain/releases
...
```
git clone https://github.com/l0k18/pod/walletmain $GOPATH/src/github.com/l0k18/pod/walletmain
cd $GOPATH/src/github.com/l0k18/pod/walletmain
glide install
```
...
```bash
$ cp $GOPATH/src/github.com/l0k18/pod/sample-pod.conf ~/.pod/pod.conf
$ cp $GOPATH/src/github.com/l0k18/pod/walletmain/sample-btcwallet.conf ~/.btcwallet/btcwallet.conf
$ $EDITOR ~/.pod/pod.conf
...
The [integrated github issue tracker](https://github.com/l0k18/pod/walletmain/issues)
