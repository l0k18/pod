...
[![GoDoc](https://godoc.org/github.com/l0k18/pod/walletmain/walletdb?status.png)]
(http://godoc.org/github.com/l0k18/pod/walletmain/walletdb)
...
http://localhost:6060/pkg/github.com/l0k18/pod/walletmain/walletdb

## Installation

```bash
$ go get github.com/l0k18/pod/walletmain/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/l0k18/pod/walletmain/walletdb#example-package--BasicUsage)  
