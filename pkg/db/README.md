...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/l0k18/pod/database)
...
When a client wants programmatic access to the data provided by pod, they'll likely want to use the [rpcclient](https://github.com/l0k18/pod/tree/master/rpcclient) package which makes use of the [JSON-RPC API](https://github.com/l0k18/pod/tree/master/docs/json_rpc_api.md).
...
```bash
$ go get -u github.com/l0k18/pod/database
```

## Examples

- [Basic Usage Example](http://godoc.org/github.com/l0k18/pod/database#example-package--BasicUsage)  
  Demonstrates creating a new database and using a managed read-write transaction to store and retrieve metadata.

- [Block Storage and Retrieval Example](http://godoc.org/github.com/l0k18/pod/database#example-package--BlockStorageAndRetrieval)  
