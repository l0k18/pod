...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/l0k18/pod/rpcclient)
...
- [API Reference](http://godoc.org/github.com/l0k18/pod/rpcclient)

- [pod Websockets Example](https://github.com/l0k18/pod/tree/master/rpcclient/examples/podwebsockets)
...
- [btcwallet Websockets Example](https://github.com/l0k18/pod/tree/master/rpcclient/examples/btcwalletwebsockets)
...
- [Bitcoin Core HTTP POST Example](https://github.com/l0k18/pod/tree/master/rpcclient/examples/bitcoincorehttp)
...
```bash
$ go get -u github.com/l0k18/pod/rpcclient
```
