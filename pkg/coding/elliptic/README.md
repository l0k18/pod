...
[![GoDoc](https://godoc.org/github.com/l0k18/pod/btcec?status.png)](http://godoc.org/github.com/l0k18/pod/btcec)
...
```bash
$ go get -u github.com/l0k18/pod/btcec
```

## Examples

- [Sign Message](http://godoc.org/github.com/l0k18/pod/btcec#example-package--SignMessage)  
  Demonstrates signing a message with a secp256k1 private key that is first
  parsed form raw bytes and serializing the generated signature.

- [Verify Signature](http://godoc.org/github.com/l0k18/pod/btcec#example-package--VerifySignature)  
  Demonstrates verifying a secp256k1 signature against a public key that is
  first parsed from raw bytes. The signature is also parsed from raw bytes.

- [Encryption](http://godoc.org/github.com/l0k18/pod/btcec#example-package--EncryptMessage)
  Demonstrates encrypting a message for a public key that is first parsed from
  raw bytes, then decrypting it using the corresponding private key.

- [Decryption](http://godoc.org/github.com/l0k18/pod/btcec#example-package--DecryptMessage)
