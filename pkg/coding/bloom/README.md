...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/l0k18/pod/util/bloom)
...
```bash
$ go get -u github.com/l0k18/pod/bloom
```

## Examples

- [NewFilter Example](http://godoc.org/github.com/l0k18/pod/util/bloom#example-NewFilter)  
